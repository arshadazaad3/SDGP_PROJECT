...
keywordToSearch = 'corona virus'
user_keyword_list = [keywordToSearch]
user_category = 'health_environment'
...
# code to randomly select twitter account accoirding to user category
...
tweetsfromCategory = api.user_timeline(category_account, count=5)

tweet1 = api.search(category_account,
...
for each_json_tweet in tweetsfromCategory:
...
try:
    ...
    print("Error in specific category")
