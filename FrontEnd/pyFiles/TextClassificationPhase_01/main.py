...
related_searches_list = RelatedSearches.myFunction(userKeywordFromNode)
# print(related_searches_list)
import tweetScrapeAndSave
# tweetScrapeAndSave.tweetScrapeFunction(related_searches_list)
tweetScrapeAndSave.tweetScrapeFunction(related_searches_list, userKeywordFromNode)
...
#Get Keyword passed from React to Node
userCategoryFromNode = finalResult
...
#         data_dict = data.to_dict("records")
#         db = client[clientdatabaseName]  # make clinet database
#         db.tweetsone.drop()  # drop table
#         tweetCollection = db['tweetsone']  # create table
...
# DELETE THIS LINE AFTER CATEGORY CODE IS IMPLEMENTED -------------------------------------------
